...
import 'package:get_storage/get_storage.d0art';
import 'package:in_app_purchase/in_app_purchase.dart';
import 'dart:io';

import 'package:toppay/utils/get_tool/get_tool.dart';

class TopupController extends GetxController with GetTool {
  // handle here
...
// here to add more Products in this case we have 2 Product IDsß
  RxList products = [].obs;
...
//     }
  ...
  //   products.assignAll(response.productDetails..sort((a, b) => a.price.compareTo(b.price)));
  // }
  ...
  //   var res = await BalanceService().addMoney(data: {'money': money, 'purchaseId': purchaseId});
  //   Get.back();
  //   if (res != null && res['error'] == 0) {
  //     notify.success(title: "Thành công", message: "Bạn được cộng $money vào tài khoản", timeout: 3000);
  //     balance.value += money;
  //   } else {
