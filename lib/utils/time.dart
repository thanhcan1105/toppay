...
class $Datetime {
  ...
  static String stringToLocalDateTime(datetimeString) {
    return DateFormat('dd/MM/yyyy hh:mm').format(DateTime.parse(datetimeString).toLocal()).toString();
  }
  ...
  // }) {
  //   DateTime now =
  //       $Datetime.replace(DateTime.now(), hour: 0, minute: 0, second: 0);
  //   DateTime dateCompare =
  //       $Datetime.replace(datetime, hour: 0, minute: 0, second: 0);
